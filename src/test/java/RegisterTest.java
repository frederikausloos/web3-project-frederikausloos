...
public class RegisterTest {
	...
	private String path = "http://localhost:8080/test_war_exploded/Servlet";
	...
	public void setUp() {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\qnap\\UCLL\\extra\\chromedriver.exe");
	...
	public void test_Register_AllFieldsFilledInCorrectly_UserIsRegistered() {
		...
		driver.get(path+"?command=PersonOverview");
